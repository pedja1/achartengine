...
public class XYMultipleSeriesRenderer extends DefaultRenderer {
  ...
  /** The Y axis icons. */
  private Map<Integer, Map<Double, Bitmap>> mYIcons = new LinkedHashMap<Integer, Map<Double, Bitmap>>();
  ...
  public void initAxesRangeForScale(int i) {
    ...
    mYTitle[i] = "";
    mYIcons.put(i, new HashMap<Double, Bitmap>());
  ...
  public void setXRoundedLabels(boolean rounded) {
     ...
     */
    public void addYIcon(double y, Bitmap bitmap) {
        addYIcon(y, bitmap, 0);
    }
   ...
   * @param y the Y axis value
   */
  public void removeYIcon(double y) {
    removeYIcon(y, 0);
  }
   ...
   * 
   * @param y the Y axis value
   * @param bitmap the bitmap label
   * @param scale the renderer scale
   */
  public synchronized void addYIcon(double y, Bitmap bitmap, int scale) {
    mYIcons.get(scale).put(y, bitmap);
  }
   ...
   * @param scale the renderer scale
   */
  public synchronized void removeYIcon(double y, int scale) {
    mYIcons.get(scale).remove(y);
  }
     ...
     */
    public synchronized Bitmap getYIcon(Double y, int scale) {
        return mYIcons.get(scale).get(y);
    }
   ...
   */
  public Double[] getYIconLocations() {
    return getYIconLocations(0);
  }
   ...
   * @return the Y text label locations
   */
  public synchronized Double[] getYIconLocations(int scale) {
    return mYIcons.get(scale).keySet().toArray(new Double[0]);
  }

  /**
   * Clears the existing text labels on the Y axis.
   */
  public void clearYIcons() {
    clearYIcons(0);
  }
   ...
   * @param scale the renderer scale
   */
  public synchronized void clearYIcons(int scale) {
    mYIcons.get(scale).clear();
  }
